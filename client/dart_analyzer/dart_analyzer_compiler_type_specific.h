...
#ifndef DEVTOOLS_GOMA_CLIENT_DART_ANALYZER_DART_ANALYZER_COMPILER_TYPE_SPECIFIC_H_
#define DEVTOOLS_GOMA_CLIENT_DART_ANALYZER_DART_ANALYZER_COMPILER_TYPE_SPECIFIC_H_
...
class DartAnalyzerCompilerTypeSpecific : public CompilerTypeSpecific {
 public:
  ~DartAnalyzerCompilerTypeSpecific() override;

  DartAnalyzerCompilerTypeSpecific(const DartAnalyzerCompilerTypeSpecific&) =
      delete;
  void operator=(const DartAnalyzerCompilerTypeSpecific&) = delete;
 ...
 private:
  DartAnalyzerCompilerTypeSpecific() = default;

  DartAnalyzerCompilerInfoBuilder compiler_info_builder_;
...
#endif  // DEVTOOLS_GOMA_CLIENT_DART_ANALYZER_DART_ANALYZER_COMPILER_TYPE_SPECIFIC_H_
