...
class CompilerFlags {
 public:
  ...
  // see field's comment below.
  const std::vector<std::string>& expanded_args() const {
  ...
  // see field's comment below.
  const std::vector<std::string>& output_dirs() const { return output_dirs_; }
  ...
  // see field's comment below.
  const std::vector<std::string>& optional_input_filenames() const {
  ...
  std::string compiler_base_name() const;
  // Returns compiler's family name.
  // e.g.
  //   "gcc" for "/usr/bin/gcc",
  //   "gcc" for "/usr/bin/x86_64-linux-gcc-7",
  //   "g++" for "/usr/bin/g++".
  virtual std::string compiler_name() const = 0;

  // see field's comment below.
  virtual std::string lang() const { return lang_; }
  ...
  virtual const std::string& cwd_for_include_processor() const { return cwd_; }

  // see field's comment below.
  const std::vector<std::string>& compiler_info_flags() const {
    return compiler_info_flags_;
  }
  // see field's comment below.
  const std::vector<std::string>& unknown_flags() const {
 ...
 protected:
  ...
  CompilerFlags(const std::vector<std::string>& args, std::string cwd);
  ...
  std::vector<std::string> expanded_args_;
  ...
  std::vector<std::string> optional_input_filenames_;
  ...
  std::vector<std::string> compiler_info_flags_;
